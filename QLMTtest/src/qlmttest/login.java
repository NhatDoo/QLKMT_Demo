...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("nhập pasword");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 36)); // NOI18N
        jLabel3.setText("Quản Lí Kho Máy Tính");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
       if(user.getText().equals("")||pw.getText().equals(""))
       {
         JOptionPane.showMessageDialog(rootPane,"vui lòng điền đủ thông tin ");
       }
       else if (user.getText().equals("nhatdoo")&&pw.getText().equals("nhat123456789"))
       {
       ...
       {
           JOptionPane.showMessageDialog(rootPane, "vui lòng kiểm tra lại username hoặc password","Messenger",JOptionPane.ERROR_MESSAGE);
       }
